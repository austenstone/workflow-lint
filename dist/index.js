...
module.exports = eval("require")("./model/convert");
...
module.exports = eval("require")("./templates/tokens/type-guards");
...
module.exports = eval("require")("./templates/trace-writer");
...
module.exports = eval("require")("./workflows/workflow-parser");
...
// EXTERNAL MODULE: ./node_modules/@vercel/ncc/dist/ncc/@@notfound.js?./model/convert
var convert = __nccwpck_require__(3842);
// EXTERNAL MODULE: ./node_modules/@vercel/ncc/dist/ncc/@@notfound.js?./templates/tokens/type-guards
var type_guards = __nccwpck_require__(6415);
// EXTERNAL MODULE: ./node_modules/@vercel/ncc/dist/ncc/@@notfound.js?./templates/trace-writer
var trace_writer = __nccwpck_require__(1244);
// EXTERNAL MODULE: ./node_modules/@vercel/ncc/dist/ncc/@@notfound.js?./workflows/workflow-parser
var workflow_parser = __nccwpck_require__(4122);
;// CONCATENATED MODULE: ./node_modules/@actions/workflow-parser/dist/index.js
...
function getInputs() {
    ...
    result.owner = (0,core.getInput)('owner');
    result.repo = (0,core.getInput)('repo');
    return result;
}
const run = async () => {
    ...
    workflowFiles.map(file => {
        return (0,external_fs_.readFileSync)(file.filename, "utf8");
    });
    const result = (0,workflow_parser.parseWorkflow)({
        name: '123',
        content: '123'
    }, new trace_writer.NoOperationTraceWriter());
    console.log(result);
};
run();
